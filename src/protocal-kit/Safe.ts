...
class Safe {
  ...
  async createTransaction({
    ...
    console.log("inside create safe transaction");
    const safeVersion = await this.getContractVersion()
    console.log("safe version is:");
    ...
    console.log("about to create EthSafeTransaction");
    const output = new EthSafeTransaction(
      await standardizeSafeTransactionData({
    ...
    console.log("Eth SafeTransaction is:");
    console.log(output);
    return output;
  }
  ...
  async getTransactionHash(safeTransaction: SafeTransaction): Promise<string> {
    ...
    console.log("safeTransactionData is");
